...
const Header = () => {
  ...
  return (
    <>
        ...
        <div className="w-10/12 m-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-4 text-white">
              {/* <BiLogoTwitter className="hover:text-orange-500 hover:scale-150" />
              <BiLogoFacebook className="hover:text-orange-500 hover:scale-150" />
              <BiLogoLinkedin className="hover:text-orange-500 hover:scale-150" /> */}
      ...
      <div>
        <div
          className={`w-1/5 fixed top-0 right-0 z-10 h-full transform ${
                      ...
                      >
                        <ul>
                          {val.page.map((val, key) => (
                            <li
                              key={key}
                              className="px-5 py-3 bg-white shadow-md hover:text-orange-500"
                            >
